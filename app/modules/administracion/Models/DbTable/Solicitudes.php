...
class Administracion_Model_DbTable_Solicitudes extends Db_Table
{
	...
	public function updateExtraFields($id, $fields)
	{
		...
		$query = "UPDATE solicitudes SET " . implode(', ', $setParts) . " WHERE solicitud_id = '" . $id . "'";
