 ...
 */
class Administracion_Model_DbTable_Logsolicitudes extends Db_Table
{
	/**
	 * [ nombre de la tabla actual]
	 * @var string
	 */
	protected $_name = 'log_solicitudes';
