    ...
    <div class="contenedor-card mb-4">
      <div class="card kpi-card kpi-card--origen">
        <div class="kpi-info">
          ...
          <p class="kpi-value-small"><strong>Auto gestión:</strong> <?= $desdePublica; ?><br>
            <strong>Gestores:</strong> <?= $desdeAdmin; ?>
          </p>
        </div>
        <div class="kpi-icon" aria-hidden="true">
...
<script>
  document.addEventListener('DOMContentLoaded', function () {
    ...
    function createUserBarChart (config) {
      ...
      // Mostrar labels en mayúsculas para mayor consistencia visual
      const displayLabels = labels.map(function (l) { return (typeof l === 'string') ? l.toUpperCase() : l; });
      const barsCount = displayLabels.length || 1;
