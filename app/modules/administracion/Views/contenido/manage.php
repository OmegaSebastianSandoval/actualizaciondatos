...
<div class="container-fluid">
	<form class="text-start" enctype="multipart/form-data" method="post" action="<?php echo $this->routeform; ?>"
		...
		<div class="content-dashboard">
			...
			<div class="row">
				...
				<div class="col-2 form-group">
					<label class="control-label" for="contenido_estado">Activar Contendido</label><br>
					<input type="checkbox" name="contenido_estado" id="contenido_estado" value="1" data-toggle="toggle"
						class="form-control" data-onstyle="success" <?php if ($this->getObjectVariable($this->content, 'contenido_estado') == 1) {
							echo "checked";
				...
				<?php } ?>
				<?php if ($this->mostrartipos == 1 || $padre == 0 || ($this->contentpadre->contenido_tipo == 3 && $this->contentpadre->contenido_enlace_abrir == 2)) { ?>
					<div class="col-3 form-group">
			...
			<div class="col-3 form-group no-banner no-carrousel no-acordion si-seccion" <?php if ($tipo != 2 && $tipo != 4) { ?>
				...
				<div class="row">
					<div class="col-2">
						<label class="radio-col">
							<input type="radio" value="col-sm-12" <?php if ($this->content->contenido_columna == 'col-sm-12') { ?> checked
								<?php } ?> name="contenido_columna" id="contenido_columna" class="form-control">
							<span>
					...
					<div class="col-2">
						<label class="radio-col">
							<input type="radio" value="col-sm-6" <?php if ($this->content->contenido_columna == 'col-sm-6') { ?> checked
								<?php } ?> name="contenido_columna" id="contenido_columna" class="form-control">
							<span>
					...
					<div class="col-2">
						<label class="radio-col">
							<input type="radio" value="col-sm-4" <?php if ($this->content->contenido_columna == 'col-sm-4') { ?> checked
								<?php } ?> name="contenido_columna" id="contenido_columna" class="form-control">
							<span>
					...
					<div class="col-2">
						<label class="radio-col">
							<input type="radio" value="col-sm-3" <?php if ($this->content->contenido_columna == 'col-sm-3') { ?> checked
								<?php } ?> name="contenido_columna" id="contenido_columna" class="form-control">
							<span>
					...
					<div class="col-2 no-carrousel2 ">
						<label class="radio-col">
							<input type="radio" value="col-sm-8" <?php if ($this->content->contenido_columna == 'col-sm-8') { ?> checked
								<?php } ?> name="contenido_columna" id="contenido_columna" class="form-control">
							<span>
					...
					<div class="col-2 no-carrousel2 ">
						<label class="radio-col">
							<input type="radio" value="col-sm-9" <?php if ($this->content->contenido_columna == 'col-sm-9') { ?> checked
								<?php } ?> name="contenido_columna" id="contenido_columna" class="form-control">
							<span>
		...
		<input type="text" value="<?= $this->content->contenido_titulo; ?>" name="contenido_titulo" id="contenido_titulo"
			class="form-control">
		</label>
		<div class="help-block with-errors"></div>
</div>
...
<div class="col-4 form-group no-banner no-acordion no-carrousel si-seccion" <?php if ($tipo != 2 && $tipo != 4) { ?>
		style="display: none;" <?php } ?>>
	<label for="contenido_fondo_imagen"><?php if ($tipo == 4) { ?>Imagen Banner <?php } else { ?> Imagen de Fondo
		<?php } ?></label>
...
<div class="col-4 form-group no-contenido no-banner si-seccion no-acordion si-carrousel si-contenido2" <?php if ($tipo != 2 && $tipo != 4 && $tipo != 5 && $tipo != 6) { ?> style="display: none;" <?php } ?>>
	<label for="contenido_fondo_color" class="control-label"><?php if ($tipo == 4) { ?> Color Caption <?php } else { ?>
			Color
			de Fondo <?php } ?></label>
	<label class="input-group">
...
<div class="col-12 form-group no-banner no-carrousel no-seccion no-acordion si-contenido" <?php if ($tipo != 3) { ?>
		style="display: none;" <?php } ?>>
...
<div class="row no-banner si-seccion si-contenido no-acordion no-carrousel si-contenido2" <?php if ($tipo == 1 || $tipo == 6 || $tipo == 7 || ($tipo == 0 && $this->contentpadre->contenido_tipo == 2)) { ?> style="display: none;" <?php } ?>>
	...
	<input type="text" value="<?= $this->content->contenido_enlace; ?>" name="contenido_enlace" id="contenido_enlace"
		class="form-control">
...
<input type="text" value="<?= $this->content->contenido_vermas; ?>" name="contenido_vermas" id="contenido_vermas"
	class="form-control">
</label>
<div class="help-block with-errors"></div>
</div>
