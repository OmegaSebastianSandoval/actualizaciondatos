			...
			<div class="row">
				...
				<div class="col-3">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="contenido_titulo"
								...
								<div>
									<?php if ($content->contenido_tipo == 1) { ?>
										<a class="btn btn-rosado btn-sm" href="<?php echo $this->route; ?>?padre=<?= $id ?>"
											data-toggle="tooltip" data-placement="top" title="Banners"><i class="fas fa-images"></i></a>
									<?php } ?>
									<?php if ($content->contenido_tipo == 2) { ?>
										<a class="btn btn-rosado btn-sm" href="<?php echo $this->route; ?>?padre=<?= $id ?>"
											data-toggle="tooltip" data-placement="top" title="Columnas"><i class="fas fa-columns"></i></a>
									<?php } ?>
									<?php if ($content->contenido_tipo == 6 || $content->contenido_tipo == 7) { ?>
										<a class="btn btn-rosado btn-sm" href="<?php echo $this->route; ?>?padre=<?= $id ?>"
											data-toggle="tooltip" data-placement="top" title="Elementos"><i class="fas fa-plus-square"></i></a>
									<?php } ?>
									<?php if ($content->contenido_tipo == 3 && $content->contenido_enlace_abrir == 2) { ?>
										<a class="btn btn-rosado btn-sm" href="<?php echo $this->route; ?>?padre=<?= $id ?>"
											data-toggle="tooltip" data-placement="top" title="interna"><i class="fas fa-plus-square"></i></a>
									<?php } ?>
