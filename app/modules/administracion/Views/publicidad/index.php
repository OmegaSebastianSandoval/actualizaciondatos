...
<div class="container-fluid">
	<form action="<?php echo $this->route; ?>" method="post">
		<div class="content-dashboard">
			...
			<input type="text" class="form-control" name="publicidad_fecha"
				value="<?php echo $this->getObjectVariable($this->filters, 'publicidad_fecha') ?>"></input>
			</label>
		</div>
		<div class="col-3">
			<label>Imagen</label>
		...
		<input type="text" class="form-control" name="publicidad_imagen"
			value="<?php echo $this->getObjectVariable($this->filters, 'publicidad_imagen') ?>"></input>
		</label>
</div>
<div class="col-3">
	<label>Video</label>
