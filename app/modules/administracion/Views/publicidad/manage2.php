		...
		<div class="content-dashboard">
			...
			<div class="row">
				...
				<input type="text" value="<?php if ($this->content->publicidad_fecha) {
					...
					echo date('Y-m-d');
				} ?>" name="publicidad_fecha" id="publicidad_fecha" class="form-control" required data-provide="datepicker"
			...
			<div class="col-6 form-group">
				...
				<input type="file" name="publicidad_imagen" id="publicidad_imagen" class="form-control  file-image"
					data-buttonName="btn-primary" onchange="validarimagen('publicidad_imagen');"
				...
				<?php if ($this->content->publicidad_imagen) { ?>
					<div id="imagen_publicidad_imagen">
						...
						<div><button class="btn btn-danger btn-sm" type="button"
								onclick="eliminarImagen('publicidad_imagen','<?php echo $this->route . "/deleteimage"; ?>')"><i
...
<input type="text" value="<?= $this->content->publicidad_enlace; ?>" name="publicidad_enlace" id="publicidad_enlace"
	class="form-control">
</label>
<div class="help-block with-errors"></div>
</div>
