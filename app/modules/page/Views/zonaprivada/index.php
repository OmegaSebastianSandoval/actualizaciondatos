...
<div class="container">
	<div class="row">
		<div class="col-12 titulo-contact">
			<br>
			<h2 class="contact">Login zona privada</h2>
		</div>
		<div class="col-12">
			<br>
			...
			<div class="col-md-12 col-lg-6 form-group">
				<div class="col-sm-12 col-md-12 margen_icono">
					<div class="row">
						...
						<div class="col-md-12"><input type="text" name="cedula" required
								class="form-control texto_normal campo_login" value="<?php echo $_GET['cedula']; ?>" placeholder="">
						</div>
				...
				<div class="col-sm-12 col-md-12">
					<div class="row">
						...
						<div class="col-md-12"><input type="text" name="clave" required
								class="form-control texto_normal campo_login" value="" placeholder=""></div>
					</div>
				</div>


				<div class="col-md-12 text-center d-none"><br><a href="/page/registro" class="enlace d-none">Crear cuenta</a>
					<span class="azul d-none">|</span> <a href="/page/login/recordar/" class="enlace">¿Haz olvidado tu
						contraseña?</a></div>
