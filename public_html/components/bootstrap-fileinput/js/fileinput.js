...
(function (factory) {
  ...
  $h = {
    ...
    uniqId: function () {
      return (
        Math.round(new Date().getTime()) + "_" + Math.round(Math.random() * 100)
      );
    },
  ...
  FileInput.prototype = {
        ...
        get: function (i, isDisabled) {
          var ind = "init_" + i,
            ...
            parseTemplate = function (cat, dat, fn, ft, id, ftr, ind, fc, t) {
              fc =
                " file-preview-initial " + $h.SORT_CSS + (fc ? " " + fc : "");
    ...
    _showUploadError: function (msg, params, event) {
      var self = this,
        ...
        e =
          params && params.id
            ? '<li data-thumb-id="' + params.id + '">' + msg + "</li>"
            : "<li>" + msg + "</li>";
    ...
    _ajaxSubmit: function (
      ...
      vUrl =
        index && self.uploadUrlThumb ? self.uploadUrlThumb : self.uploadUrl;
      settings = $.extend(
        true,
        {},
        {
    ...
    _uploadSingle: function (i, isBatch) {
      var self = this,
        ...
        $btnDelete,
        hasPostData =
          self.filestack.length > 0 || !$.isEmptyObject(self.uploadExtraData),
        uploadFailed,
    ...
    _generatePreviewTemplate: function (
      ...
      var self = this,
        ...
        config =
          screenW < 400
            ? self.previewSettingsSmall[cat] ||
              self.defaults.previewSettingsSmall[cat]
    ...
    _addToPreview: function ($preview, content) {
      var self = this;
      return self.reversePreviewOrder
    ...
    _validateImageOrientation: function (
      ...
      $h.setImageOrientation(
        $img,
        self.$preview.find("#zoom-" + previewId + " img"),
        value,
      );
    ...
    _change: function (e) {
      ...
      var $el = self.$element,
        ...
        total,
        maxCount =
          !isAjaxUpload && $h.isEmpty($el.attr("multiple"))
            ? 1
            : self.maxFileCount,
        len,
      ...
      total = self._getFileCount(
        isAjaxUpload ? self.getFileStack().length + len : len,
      );
    ...
    readFiles: function (files) {
      ...
      var self = this,
        ...
        maxPreviewSize =
          self.maxFilePreviewSize && parseFloat(self.maxFilePreviewSize),
        canPreview =
          $preview.length && (!maxPreviewSize || isNaN(maxPreviewSize)),
