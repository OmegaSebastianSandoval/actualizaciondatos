 ...
 */ !(function (e) {
  ...
  ((t = {
    ...
    isEmpty: function (t, i) {
      return (
        void 0 === t || null === t || 0 === t.length || (i && "" === e.trim(t))
      );
    },
    isArray: function (e) {
      return (
    ...
    uniqId: function () {
      return (
        Math.round(new Date().getTime()) + "_" + Math.round(100 * Math.random())
      );
    },
      ...
      if (e && e.length) {
        ...
        e.off(r).on(r, function () {
          var r = e.get(0),
            ...
            l = r.offsetWidth,
            s = t.getRotation(a);
          if ((e.data("orientation", a), n && i.data("orientation", a), 5 > a))
            return (t.setTransform(r, s), void t.setTransform(n, s));
          var d = Math.atan(l / o),
    ...
    (i.prototype = {
      ...
      _initTemplateDefaults: function () {
        ...
        ((i =
          ...
          (M = { width: "100%", height: "100%", "min-height": "480px" }),
          Z._isPdfRendered() &&
            (R = Z.pdfRendererTemplate.replace(
              "{renderer}",
        ...
        ((i.previewCache = {
          ...
          get: function (a, r) {
            var n,
              ...
              w = m
                ? { title: m.title || null, alt: m.alt || null }
                : { title: null, alt: null },
              _ = function (e, a, r, n, o, l, s, d, c) {
                return (
                  (d =
            ...
            return v
              ? ((r = void 0 === r ? !0 : r),
                ...
                (u = t.ifSet("frameClass", m)),
                (n = h
                  ? _(l, v, d, c, g, s, p, u)
                  : _("generic", v, d, c, g, s, p, u, l).setTokens({
                      content: f.content[a],
                    })),
          ...
          footer: function (e, a, r) {
            ...
            var o,
              ...
              g = !!m,
              h = t.ifSet("showRemove", l, t.ifSet("showRemove", p, f)),
              w = t.ifSet("showDownload", l, t.ifSet("showDownload", p, g)),
              _ = t.ifSet("showZoom", l, t.ifSet("showZoom", p, !0)),
              b = t.ifSet("showDrag", l, t.ifSet("showDrag", p, !0)),
              C = c === !1 && a;
            return (
              (w = w && l.downloadUrl !== !1 && !!m),
              (o = i._renderFileActions(!1, w, h, _, b, C, c, u, !0, m, v)),
              i
      ...
      _setZoomContent: function (i, a) {
        ...
        ((n = g.attr("data-template") || "generic"),
          ...
          h.data("previewId", v),
          m._handler(h.find(".btn-prev"), "click", function () {
          ...
          m._handler(h, "keydown", function (t) {
            ...
            (i === o &&
              a.length &&
              !a.attr("disabled") &&
              m._zoomSlideShow("prev", n),
              i === l &&
                r.length &&
                !r.attr("disabled") &&
                m._zoomSlideShow("next", n));
          }));
      },
      ...
      _ajaxSubmit: function (t, i, a, r, n, o) {
        var l,
          s,
          d = this;
        d._raise("filepreajax", [n, o]) &&
          (d._uploadExtra(n, o),
          d._initAjaxSettings(),
          d._mergeAjaxCallback("beforeSend", t),
          d._mergeAjaxCallback("success", i),
          d._mergeAjaxCallback("complete", a),
          d._mergeAjaxCallback("error", r),
          (s = o && d.uploadUrlThumb ? d.uploadUrlThumb : d.uploadUrl),
          (l = e.extend(
            !0,
            {},
            {
          ...
          void 0 !== a
            ? r
              ? ((f = a.attr("data-fileindex")),
                ...
                (m.uploadCache.config[f] = u[0] || []),
                (m.uploadCache.tags[f] = p[0] || []),
                (m.uploadCache.append = n))
              : ((l = m.previewCache.add(c, u[0], p[0], n)),
      ...
      _uploadSingle: function (i, a) {
        ...
        ((v.formdata = h),
          ...
          0 === g ||
            ...
            (u = function (o, s, c) {
              var u = v.showPreview && n.attr("id") ? n.attr("id") : w;
              ((r = v._getOutData(c, o)),
                e.extend(!0, C, r),
                setTimeout(function () {
                  t.isEmpty(o) || t.isEmpty(o.error)
                    ? (v.showPreview &&
                      ...
                      v._raise("fileuploaded", [r, u, i]),
                      a ? m(i, u) : v.updateStack(i, void 0))
                    : ((d = !0),
      ...
      _generatePreviewTemplate: function (i, a, r, n, o, l, s, d, c, u, p, f) {
        var m,
          v,
          g = this,
          h = g.slug(r),
          ...
          C =
            400 > b
              ? g.previewSettingsSmall[i] || g.defaults.previewSettingsSmall[i]
              : g.previewSettings[i] || g.defaults.previewSettings[i],
          y = h,
          x = h,
          T = c || g._renderFileFooter(h, s, "auto", l),
          E = g._getPreviewIcon(r),
          S = "type-default",
          k = E && g.preferIconicPreview,
          F = E && g.preferIconicZoomPreview;
        return (
          C &&
            e.each(C, function (e, t) {
              _ += e + ":" + t + ";";
          ...
          (v = function (a, l, s, c) {
            var m = s ? "zoom-" + o : o,
              v = g._getPreviewTemplate(a),
              w = (d || "") + " " + c;
            return (
              g.frameClass && (w = g.frameClass + " " + w),
              s && (w = w.replace(" " + t.SORT_CSS, "")),
              (v = g._parseFilePreviewIcon(v, r)),
              "text" === a && (l = t.htmlEncode(l)),
              "object" !== i ||
                n ||
                e.each(g.defaults.fileTypeSettings, function (e, t) {
                  "object" !== e &&
                    "other" !== e &&
                    t(r, n) &&
                    (S = "type-" + e);
              ...
              t.isEmpty(f) ||
                (void 0 !== f.title && null !== f.title && (y = f.title),
                void 0 !== f.alt && null !== f.alt && (y = f.alt)),
              v.setTokens({
                previewId: m,
                caption: h,
                title: y,
                alt: x,
                frameClass: w,
                type: g._getFileType(n),
                fileindex: u,
                fileid: g._getFileIds()[u] || "",
                typeCss: S,
                footer: T,
                data: l,
                template: p || i,
          ...
          (u = u || o.slice(o.lastIndexOf("-") + 1)),
          g.fileActionSettings.showZoom &&
            (w = v(F ? "other" : i, a, !0, "kv-zoom-thumb")),
          (w =
            "\n" +
            g._getLayoutTemplate("zoomCache").replace("{zoomContent}", w)),
          (m = v(k ? "other" : i, a, !1, "kv-preview-thumb")),
          m + w
        );
      },
      ...
      _previewDefault: function (i, a, r) {
        ...
        if (n.showPreview) {
          ...
          (n._clearDefaultPreview(),
            (l = n._generatePreviewTemplate("other", f, s, d, a, p, c)),
            n._addToPreview(o, l),
            n._setThumbAttr(a, u, c),
            r === !0 &&
              n.isAjaxUpload &&
      ...
      _previewFile: function (e, i, a, r, n, o) {
        if (this.showPreview) {
          ...
          if (
            ...
            ((l = s._generatePreviewTemplate(p, _, d, c, r, !1, g)),
              s._clearDefaultPreview(),
              s._addToPreview(v, l));
            var b = v.find("#" + r + " img");
            s._validateImageOrientation(b, i, r, u, c, g, _);
          } else s._previewDefault(i, r);
          (s._setThumbAttr(r, u, g), s._initSortable());
        }
      },
      ...
      _setFileDropZoneTitle: function () {
        ...
        (i.isClickable &&
          ...
          !i.showPreview ||
            ...
            !i.dropZoneEnabled ||
            (!i.isAjaxUpload && i.$element.files) ||
        ...
        return "function" == typeof r
          ...
          : e
            ? ((i = String(
              ...
              i ? e.size + "-" + i.replace(/[^0-9a-zA-Z_-]/gim, "") : null)
            : null;
      },
      ...
      _checkDimensions: function (e, i, a, r, n, o, l) {
        ...
        !t.isEmpty(m) &&
          ...
          (u = "Small" === i ? d >= m : m >= d),
          u ||
            ((s = p["msgImage" + o + i].setTokens({ name: n, size: m })),
            p._showUploadError(s, l),
            p._setPreviewError(r, e, null)));
      },
      ...
      _validateImageOrientation: function (e, i, a, r, n, o, l) {
        ...
        return (
          ...
          (s = e.length && u ? c._getExifObj(l) : null),
          (d = s ? s["0th"][piexif.ImageIFD.Orientation] : null)
            ? (t.setImageOrientation(
                e,
                c.$preview.find("#zoom-" + a + " img"),
                d,
              ),
              c._raise("fileimageoriented", { $img: e, file: i }),
              void c._validateImage(a, r, n, o, l, s))
            : void c._validateImage(a, r, n, o, l, s)
        );
      },
          ...
          m
            .one("load", function () {
              ((s = p.width()),
                ...
                s > d && m.css("width", "100%"),
                (l = { ind: f, id: t }),
                c._checkDimensions(f, "Small", m, p, i, "Width", l),
                c._checkDimensions(f, "Small", m, p, i, "Height", l),
                c.resizeImage ||
                  (c._checkDimensions(f, "Large", m, p, i, "Width", l),
                  c._checkDimensions(f, "Large", m, p, i, "Height", l)),
      ...
      _getResizedImage: function (i, a, r) {
        ...
        if (
          ((d = function (e, t, i) {
            (p.isAjaxUpload
              ...
              : p._showError(e, t, i),
              p._setPreviewError(E, T));
          }),
          (!p.filestack[T] || !_ || (h >= m && w >= v)) &&
            (_ && p.filestack[T] && p._raise("fileimageresized", [x, T]),
            a.val++,
            a.val === r && p._raise("fileimagesresized"),
            !_))
        )
          return void d(
        ...
        try {
          (C.drawImage(f, 0, 0, m, v),
            (s = b.toDataURL(y, p.resizeQuality)),
            S &&
              ((u = window.piexif.dump(S)), (s = window.piexif.insert(u, s))),
            (n = t.dataURI2Blob(s)),
            (p.filestack[T] = n),
            p._raise("fileimageresized", [x, T]),
            a.val++,
            a.val === r && p._raise("fileimagesresized", [void 0, void 0]),
            n instanceof Blob ||
              d(
                p.msgImageResizeError,
                { id: x, index: T },
          ...
          (a.val++,
            a.val === r && p._raise("fileimagesresized", [void 0, void 0]),
            (c = p.msgImageResizeException.replace("{errors}", k.message)),
      ...
      _renderFileActions: function (e, t, i, a, r, n, o, l, s, d, c) {
        ...
        return (
          ...
          r &&
            s &&
            ((u = "drag-handle-init " + C.dragClass),
            (_ = p
      ...
      _change: function (i) {
        ...
        if (!a.changeTriggered) {
          var r,
            ...
            u = !s && t.isEmpty(o.attr("multiple")) ? 1 : a.maxFileCount,
            p = a.filestack.length,
          ...
          if (
            ...
            return (s || a.clear(), void a._raise("fileselectnone"));
          if (
            (a._resetErrors(),
            (n = d.length),
            ...
            if (!a.autoReplace || n > u)
              return void h(a.autoReplace && n > u ? n : r, u);
            r > u && a._resetPreviewThumbs(s);
          } else
            !s || m
              ? (a._resetPreviewThumbs(!1), m && a.clearStack())
              : !s ||
                0 !== p ||
          ...
          "-1" !== s &&
            ...
            (void 0 !== d
              ? ((r[a] = d),
                ...
                (o[a] = i._getFileId(d)),
                l.attr({ id: i.previewInitId + "-" + a, "data-fileindex": a }),
                a++)
              : l.attr({
        ...
        ((r.loadedImages = []),
          ...
          (a = function (x) {
            ...
            if (B) {
              ...
              if (!t.isEmpty(g) && t.isArray(g)) {
                for (E = 0; E < g.length; E += 1)
                  ((k = g[E]),
                    (A = m[k]),
                    (q +=
                      A && "function" == typeof A && A(B.type, t.getFileName(B))
                        ? 1
                        : 0));
                if (0 === q)
                  return (
                    (S = r.msgInvalidFileType.setTokens({ name: Z, types: V })),
                    void y(S, B, R, x)
                  );
              }
              if (
              ...
              if (!r.showPreview)
                return (
                  r.isAjaxUpload && r.addToStack(B),
                  setTimeout(function () {
                    (a(x + 1), r._updateFileDetails(f));
                  }, 100),
                  void r._raise("fileloaded", [B, R, x, l])
                );
              if (!C && N > b)
                return (
                  r.addToStack(B),
                  s.addClass("file-thumb-loading"),
                  r._previewDefault(B, R),
                  r._initFileActions(),
                  r._updateFileDetails(f),
                  void a(x + 1)
                );
                    ...
                    var a,
                      ...
                      p = function (e) {
                        ...
                        ((t.onerror = function (e) {
                          ...
                          (t.onload = function (e) {
                            (r._previewFile(x, B, e, R, W, n),
                              r._initFileActions(),
                              Y());
                          }),
                          e
                            ? t.readAsText(B, r.textEncoding)
                            : t.readAsDataURL(B));
                      };
                    if (
                      ((n = { name: Z, type: B.type }),
                      ...
                      for (
                        ...
                        ((s = o[E].toString(16)), u.push(s));
                      if (
                        ((a = u.join("").toLowerCase().substring(0, 8)),
                        (c = t.getMimeType(a, "", "")),
                        t.isEmpty(c) &&
                          ((d = t.arrayBuffer2String(l.result)),
                          (c = t.isSvg(d)
                            ? "image/svg+xml"
                            : t.getMimeType(a, d, B.type))),
                        (n = { name: Z, type: c }),
                        (D = O(c, "")),
                        (z = M(c, "")),
                        ($ = L(c, "")),
